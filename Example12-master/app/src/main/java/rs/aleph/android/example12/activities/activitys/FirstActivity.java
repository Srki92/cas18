package rs.aleph.android.example12.activities.activitys;
...
public class FirstActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) 	{
		...
		ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, jela);
